...
def test_per_contract_risk_returns_zero_when_risk_budget_is_below_one_contract():
...
def test_per_contract_risk_calculates_quantity_from_risk_budget():
    strategy = PerContractRiskSizing(risk_per_contract=5_000)
