...
本文件的 92 capability blocks 已完成 603 engineering-leaf rebase；official progress metric 使用 lifecycle-weighted 38.72% baseline。
...
| TOTAL | 92 | 38.72% lifecycle-weighted |
